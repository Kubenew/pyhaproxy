...
def create_app(frontend: Frontend, registry: BackendRegistry, metrics_enabled: bool, metrics_path: str) -> Starlette:
    async def handler(request: Request) -> Response:
        ...
        REQ_COUNT.labels(frontend=frontend.name, backend=backend_name, method=request.method, status=str(resp.status_code)).inc()
